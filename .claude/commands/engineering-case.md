...
# Engineering Case Command

Use this command when the user asks to create, generate, design, review, or practice a realistic data engineering / data management case scenario.

This command is for C-level practice:
...
- A-level: micro-pattern drills
- B-level: medium implementation challenge, handled by `/interview-challenge`
- C-level: realistic domain case, handled by this command
