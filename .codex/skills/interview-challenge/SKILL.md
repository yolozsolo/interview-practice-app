...
# Interview Challenge Skill

Use this skill when the user asks to create, initialize, generate, review, or grade a technical interview practice challenge.
...
This skill should keep the workflow simple.
